...
foreach(_cmake_expected_target IN ITEMS LLVMHello FileCheck llvm-PerfectShuffle count not UnicodeNameMappingGenerator yaml-bench split-file BugpointPasses lli-child-target llvm-jitlink-executor obj2yaml yaml2obj ExampleIRTransforms Bye InlineAdvisorPlugin TestPlugin DoublerPlugin)
...
set_target_properties(LLVMHello PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/lib/LLVMHello.so"
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/not"
  )
...
set_target_properties(UnicodeNameMappingGenerator PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/UnicodeNameMappingGenerator"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/yaml-bench"
  )
...
set_target_properties(split-file PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/split-file"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/lli-child-target"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/llvm-jitlink-executor"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/obj2yaml"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/bin/yaml2obj"
  )

# Import target "ExampleIRTransforms" for configuration "Debug"
set_property(TARGET ExampleIRTransforms APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(ExampleIRTransforms PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/lib/ExampleIRTransforms.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(Bye PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/lib/Bye.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )

# Import target "InlineAdvisorPlugin" for configuration "Debug"
set_property(TARGET InlineAdvisorPlugin APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(InlineAdvisorPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/unittests/Analysis/InlineAdvisorPlugin.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(TestPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/unittests/Passes/TestPlugin.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(DoublerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/di/Projects/kagome-llvm/cmake-build-debug/llvm/unittests/Passes/DoublerPlugin.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
